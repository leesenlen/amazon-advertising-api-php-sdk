...
class Client
{
    ...
    public function doRefreshToken()
    {
        ...
        if (is_array($response_array) && array_key_exists("access_token", $response_array)) {
            ...
            CommonController::updateToken($this->config["accountSiteMapId"], $response_array);
        } else {
            // ºóÐø¿ÉÄÜÐÞ¸Ä, ²»Å×³ö´íÎó Hyd
